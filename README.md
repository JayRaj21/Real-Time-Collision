...
Real-time object detection and collision identification on a **Jetson Orin Nano** with a **Waveshare IMX219-160 CSI camera**, using **SmolVLM-500M-Instruct** as the vision-language model.
...
The SmolVLM-500M-Instruct model weights (~1 GB) are downloaded automatically on first run.
